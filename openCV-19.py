#takip edilen objeyle frame'in bulunduğu konumu ayarla
import numpy as np
import cv2
...
cv2.createTrackbar('Hue Low','myTracker',95,180,onTrack1)
cv2.createTrackbar('Hue High','myTracker',120,180,onTrack2)

cv2.createTrackbar('Hue Low2','myTracker',180,180,onTrack7)
cv2.createTrackbar('Hue High2','myTracker',180,180,onTrack8)
